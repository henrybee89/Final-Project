...
{
	if (positionRect.x + positionRect.w < p.positionRect.x || positionRect.x > p.positionRect.x + p.positionRect.w || positionRect.y + positionRect.h < p.positionRect.y || positionRect.y > p.positionRect.y + p.positionRect.h)
	{
